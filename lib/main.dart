...
void main() async {
  ...
  OneSignal.shared.setNotificationOpenedHandler(
    (OSNotificationOpenedResult result) async {
      ...
      String notificationMessage = result.notification.body ?? "Default Notification Text";
...
Future<void> storeNotification(String title, String message) async {
  ...
  notifications.insert(0, notificationText); // Insert at the beginning of the list
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: isFirstLaunch ==true ? WebviewTwo(url:'https:/marketcenter.abyssiniasoftware.com'): IntroScreen() ,
    );
  }
}
          ...
          return Scaffold(
            ...
            body: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String title = parts.length > 0 ? parts[0].trim() : "Default Title";
                String message = parts.length > 1 ? parts[1].trim() : "Default Message";
