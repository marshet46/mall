    ...
    a.then((value) {
      if (value == 0) {
        ...
        ScaffoldMessenger.of(context).showSnackBar( SnackBar(
          content: Center(child: ResponsiveImageTextWidget(
  ...
  Future<void> _checkInternetConnection() async {
    try {
      final result = await InternetAddress.lookup(
          'https://marketcenter.abyssiniasoftware.com/');
                ...
                children: [
                  ...
                  children: [
                    Container(
                      ...
                      imageUrl: 'assets/nointernet.gif',
                      text: "You have no active internet connection. Please turn on data or connect to Wi-Fi!.",
                        ),
                      ),
                    ),
